...
# LIST1 = JSON.parse(File.read('vendor/disposable/domains.json'))
# LIST2 = File.readlines('vendor/burner-email-providers/emails.txt').each {|l| l.chomp!}
# DISPOSABLE_DOMAINS = (LIST1 + LIST2).uniq

# TODO
# Create a script to generate list
